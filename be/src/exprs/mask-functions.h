...
class MaskFunctions {
 public:
  ...
  static StringVal MaskShowFirstN(FunctionContext* context, const StringVal& val);
  static StringVal MaskShowFirstN(FunctionContext* context, const StringVal& val,
  ...
  static BigIntVal MaskShowFirstN(FunctionContext* context, const BigIntVal& val);
  static BigIntVal MaskShowFirstN(FunctionContext* context, const BigIntVal& val,
      const IntVal& char_count);
  static BigIntVal MaskShowFirstN(FunctionContext* context, const BigIntVal& val,
      const IntVal& char_count, const StringVal& upper_char, const StringVal& lower_char,
  ...
  /// Overloads for masking a string value
  static StringVal MaskShowLastN(FunctionContext* context, const StringVal& val);
  static StringVal MaskShowLastN(FunctionContext* context, const StringVal& val,
      const IntVal& char_count);
  static StringVal MaskShowLastN(FunctionContext* context, const StringVal& val,
      const IntVal& char_count, const StringVal& upper_char, const StringVal& lower_char,
  ...
  static StringVal MaskShowLastN(FunctionContext* context, const StringVal& val,
      ...
      const IntVal& digit_char, const IntVal& other_char, const IntVal& number_char);
  /// Overloads for masking a numeric value
  static BigIntVal MaskShowLastN(FunctionContext* context, const BigIntVal& val);
  static BigIntVal MaskShowLastN(FunctionContext* context, const BigIntVal& val,
      const IntVal& char_count);
  static BigIntVal MaskShowLastN(FunctionContext* context, const BigIntVal& val,
      const IntVal& char_count, const StringVal& upper_char, const StringVal& lower_char,
  ...
  /// Overloads for masking a string value
  static StringVal Mask(FunctionContext* context, const StringVal& val);
  static StringVal Mask(FunctionContext* context, const StringVal& val,
  ...
  static DateVal Mask(FunctionContext* context, const DateVal& val);
  static DateVal Mask(FunctionContext* context, const DateVal& val,
      const StringVal& upper_char, const StringVal& lower_char,
      const StringVal& digit_char, const StringVal& other_char,
  ...
  static DateVal Mask(FunctionContext* context, const DateVal& val,
      ...
      const IntVal& year_value);
  /// Overloads for masking a numeric value
  static BigIntVal Mask(FunctionContext* context, const BigIntVal& val);
  static BigIntVal Mask(FunctionContext* context, const BigIntVal& val,
      const StringVal& upper_char, const StringVal& lower_char,
      const StringVal& digit_char, const StringVal& other_char,
      const IntVal& number_char);
