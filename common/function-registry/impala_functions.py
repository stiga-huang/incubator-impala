...
# Netezza compatibility char functions
  ...
  [['mask_show_first_n'], 'BIGINT', ['BIGINT', 'INT', 'INT', 'INT', 'INT', 'INT', 'INT'],
      'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'STRING', ['STRING'], 'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'STRING', ['STRING', 'INT'], 'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'STRING', ['STRING', 'INT', 'STRING', 'STRING', 'STRING', 'STRING', 'INT'],
   'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'STRING', ['STRING', 'INT', 'INT', 'INT', 'INT', 'INT', 'INT'],
   'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'BIGINT', ['BIGINT'], 'impala::MaskFunctions::MaskShowFirstN'],
  [['mask_show_last_n'], 'BIGINT', ['BIGINT', 'INT'], 'impala::MaskFunctions::MaskShowFirstN'],
